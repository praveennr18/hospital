...
const getTypeClass = (typeCode) => {
  const normalized = (typeCode || 'consultation').toLowerCase().replace(/[^a-z0-9]+/g, '-');
  switch (normalized) {
    case 'follow-up':
    case 'follow_up':
      return 'type-follow';
        ...
        <div className="doc-app-header-row">
          <div>
            ...
            <div className="doc-app-header-desc">
              Manage your appointments, update statuses, and schedule new visits.
            </div>
          </div>
          <button className="doc-app-schedule-btn" type="button" onClick={openScheduleModal}>
                      ...
                      <tr key={appointment.id || appointment.dateIso}>
                        ...
                        <td>
                          <span className={`doc-app-type-pill ${typeClass}`}>
                            {appointment.typeLabel || appointment.type}
                          </span>
                        </td>
                        ...
                        <td>
                          {appointment.status === 'scheduled' && (
                            <div className="doc-app-actions">
                              ...
                              <button
                                className="doc-app-action-btn action-noshow"
                                type="button"
                                onClick={() => applyStatusChange(appointment, 'no_show')}
                                disabled={pendingActionId === appointment.id}
                              >
                                No Show
                              </button>
